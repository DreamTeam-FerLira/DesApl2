...
public class UserClient {
	public static void main(String[] args) {
		...
		User user1 = new User();
		user1.setFirstName("Bere");
		user1.setLastName("Arias");
		try {
			Date dob = new SimpleDateFormat("yyyy-MM-dd").parse("1997-02-11");
			user1.setDob(dob);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		user1.setEmail("bere@sample.com");
		User user2 = new User();
		...
		user2.setEmail("lira@sample.com");
